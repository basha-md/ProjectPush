...
public class DragandDrop_Github_Cucumber 
{
	...
	public static void main(String[] args)
	{
		...
		WebElement drop1 = driver.findElement(By.xpath("(//div[@id='container'])[5]"));
		
		Actions a1 = new Actions(driver);
		a1.dragAndDrop(drag,drop).perform();
		a1.dragAndDrop(drag1, drop1).perform();
		
		WebElement drag2 = driver.findElement(By.xpath("(//div[@id='container'])[1]"));
